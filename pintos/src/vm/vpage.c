...
static unsigned vpage_hash(const struct hash_elem *e, void* aux UNUSED){
    struct vm_entry* vme = hash_entry(e, struct vm_entry, elem);
    return hash_int((int)vme->vaddr);
}

void vpage_action(struct hash_elem *e, void *aux UNUSED){
    struct vm_entry* vme = hash_entry(e, struct vm_entry, elem);
...
void vpage_init(struct hash *vm){
    hash_init(vm, vpage_hash, vpage_less, NULL);  
}
